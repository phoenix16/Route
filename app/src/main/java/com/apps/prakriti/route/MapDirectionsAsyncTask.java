...
public class MapDirectionsAsyncTask extends AsyncTask<String, Void, Document>
{
    ...
    public MapDirectionsAsyncTask()
    {
    }

    public MapDirectionsAsyncTask(GoogleMap googleMap, LatLng start, LatLng end, String mode)
    {
        mMap = googleMap;
        this.start = start;
        this.end = end;
...
//            Log.d(TAG, "---- MapDirectionsAsyncTask OK ----");
            try {
                ...
                MapDirectionsAsyncTask md = new MapDirectionsAsyncTask();
...
//            Log.i("CopyRights", node1.getTextContent());
    ...
    public ArrayList<LatLng> getDirections(Document doc) {
